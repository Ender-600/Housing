...
def main():
    ...
    # Load and preprocess data
    X, y = rf_model.load_and_preprocess_data()
    ...
    if tune == 'y':
        best_params = rf_model.hyperparameter_tuning(cv=5, n_iter=20)
        print("\nRe-evaluating model with best parameters:")
        metrics = rf_model.evaluate_model()
    
    # Feature importance analysis
    feature_importance = rf_model.plot_feature_importance(top_n=20)
